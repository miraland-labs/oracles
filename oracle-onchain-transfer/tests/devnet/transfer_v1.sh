#!/usr/bin/env bash
# End-to-end Devnet runbook for oracle-onchain-transfer.
#
...
#   5. oracle-onchain-transfer fetches the SLA + evidence, calls
...
#   bash oracles/oracle-onchain-transfer/tests/devnet/transfer_v1.sh
...
{
  "version": 1,
  "profile_id": "x402/onchain-transfer/v1",
